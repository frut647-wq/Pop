...
پس از فاز ۱۳: بازتعادل کامل اقتصاد (ساخت/ارتقا ≥۱۰۰۰، منابع خام <۱۰۰۰، نظامی >۳۰۰۰)، منابع نامحدود ادمین،
هر ۳ معدن رایگان از اول + قیمت ساخت/بازساخت قابل‌تنظیم، سرمایه اولیه (نفت/فلز/برق) قابل‌تنظیم،
گرسنگی واقعی با کف جمعیت ۱۰نفره، نیروی دائمی رایگان هر کارخونه، نمایش ظرفیت تخصیص جمعیت،
گزارش تولید/مصرف ساعتی، خرید حداکثر+نمایش انبار تو شاپ‌ها، راهنمای شروع بازی
"""
